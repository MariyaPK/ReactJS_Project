        ...
        <section className="hoc container clear">
          ...
          <div className="group">
            <article className="one_third first">
              <a href="#">
                <img className="btmspace-30" src="images/demo/320x220.png" alt="" />
              </a>
              ...
              <ul className="nospace btmspace-10 group font-xs">
                <li className="fl_left">
                  <time dateTime="2045-04-06">
                    6<sup>th</sup> April 2045
                  </time>
                </li>
                <li className="fl_right">
                  by <a href="#">Admin</a>
                </li>
              </ul>
              <hr />
              <p>
                Auctor cursus feugiat sed scelerisque id odio non scelerisque sed ac est rhoncus sodales ante dictum
                lacinia&hellip;
              </p>
              <p className="nospace">
            ...
            <article className="one_third">
              ...
              <ul className="nospace btmspace-10 group font-xs">
                <li className="fl_left">
                  <time dateTime="2045-04-05">
                    5<sup>th</sup> April 2045
                  </time>
                </li>
                <li className="fl_right">
                  by <a href="#">Admin</a>
              ...
              <hr />
              <p>
                Morbi tempor ac nibh eu imperdiet diam maecenas in facilisis arcu nec pulvinar risus etiam convallis lacus&hellip;
              </p>
              <p className="nospace">
                <a href="#">Read More &raquo;</a>
              </p>
            ...
            <article className="one_third">
              ...
              <ul className="nospace btmspace-10 group font-xs">
                <li className="fl_left">
                  <time dateTime="2045-04-04">
                    4<sup>th</sup> April 2045
                  </time>
                </li>
                <li className="fl_right">
                  by <a href="#">Admin</a>
              ...
              <hr />
              <p>
                Est lectus lacinia enim quis egestas leo urna id ex integer ipsum purus sagittis at eleifend et vestibulum&hellip;
              </p>
              <p className="nospace">
                <a href="#">Read More &raquo;</a>
              </p>
